pub mod types {
    ...
    new_type!(CONDITION, "t$Condition", SFlags::TERM_ALGEBRA);
}
...
pub mod functions {
    ...
    new_fun!(AND, "and"; BOOL, BOOL ; BOOL; FFlags::BUILTIN);
    new_fun!(OR, "or"; BOOL, BOOL ; BOOL; FFlags::BUILTIN);
    new_fun!(NOT, "not"; BOOL ; BOOL; FFlags::BUILTIN);
    new_fun!(TRUE, "true"; ; BOOL; FFlags::BUILTIN);
    ...
    new_fun!(IMPLIES, "=>"; BOOL, BOOL; BOOL; FFlags::BUILTIN);
...
pub mod steps {
    ...
    pub static INIT: Step = Step::new(
        ...
        Function::new_step(INIT_NAME, &vec![]),
    );
